...
const Blogs = () => {
    ...
    return (
        <div>
            ...
            <div className="bg-yellow-200 w-3/5 mx-auto py-5 mb-5">
                <p className='text-center text-black font-bold text-3xl'>Questions and Answers</p>
            </div>
            <div className='w-3/5 mx-auto mb-32 text-yellow-200'>
