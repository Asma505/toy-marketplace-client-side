        ...
        <div className='w-2/3 mx-auto my-28 py-10'>
            ...
            <form onSubmit={handleRegister}>
                <div className='text-left w-1/2 mx-auto'>
                    <label>Name</label>
                    <input className='block w-full mx-auto mb-5 pl-1 border-2 border-yellow-500' type="text" name="name" id="" placeholder=' Your Name'/>
                    ...
                    <input className='block w-full mx-auto mb-5 pl-1 border-2 border-yellow-500' type="text" name="photoURL" id="" placeholder=' Enter Photo URL'/>
                </div>
                <p className='text-center text-red-600 my-3'>{error}</p>
                <p className='text-center text-emerald-800 my-3'>{success}</p>
                <div className='text-center'>
                    <button className='w-1/2 mx-auto bg-yellow-200 text-black py-2' type="submit" name='submit'>Register</button>
                </div>                
            </form>
